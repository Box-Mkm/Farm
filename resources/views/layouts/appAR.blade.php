...
<!-- Mirrored from layerdrops.com/agriox/index-rtl.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Sep 2023 12:48:04 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('vendors/icomoon-icons/style.css') }}">
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="{{ asset('css/agriox.css') }}" />

    <!-- RTL CSS -->
    <link rel="stylesheet" href="{{ asset('css/agriox-rtl.css') }}">


    <!-- mode css -->
    <link rel="stylesheet" id="jssMode" href="{{ asset('css/modes/agriox-dark.css') }}">
