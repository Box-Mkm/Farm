...
<section class="page-header clearfix"
    style="background-image: url({{ asset('images/new-bg-orange.jpg') }});">
    <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="contact-one__content" style="font-size: larger">
                        <p class="contact-one__text" style="color: white">مرحبًا بكم في شركة عبدالدايم للمحاصيل
                        ...
                        <p>في شركة عبدالدايم، ندرك أهمية توفير منتجات تلبي المعايير المطلوبة. من خلال فهمنا الجيد
                            لديناميكيات السوق والالتزام بالتشريعات والبروتوكولات الحكومية، نعرف كيفية تلبية متطلبات
                            عملائنا المتغيرة</p>
